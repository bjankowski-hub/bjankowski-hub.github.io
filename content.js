const CONTENT = {
    ...
    project: {
      ...
      bricks: [
        ...
        },
        {
          ...
          desc: "Trois scénarios s'exécutent simultanément : règles métier par famille produit via RAG (S1), optimisation du seuil de marge minimum (S2) et intelligence concurrentielle par clustering LLM (S3). Un indice de fiabilité par référence accompagne chaque recommandation pour guider la décision humaine."
        },
        {
          num: "04", name: "Interface Intégrée", tag: "Résultante", type: "todo", statusLabel: "À construire",
          desc: "Interface centralisée orchestrant les quatre briques en un workflow unique. Dashboard de synthèse avec pré-analyse automatique, détection des références à cibler par clustering et analyse des écarts de positionnement concurrentiel. Validation humaine intégrée avant toute décision prix."
        }
      ]
    },
    skills: {
  ...
  en: {
    ...
    project: {
      ...
      context: "This thesis project, conducted in an academic framework with a global automotive manufacturer, is grounded in real industrial terrain. It is structured around four axes: identifying the pain points of pricing teams in managing large product reference catalogues; defining a data governance framework that is structured and legally compliant; designing and implementing an AI solution that addresses the identified needs; and assessing the organisational impact on affected business functions with a change management plan.",
      ...
      bricks: [
        ...
        { num: "03", name: "Multi-Scenario Pricing Engine", tag: "Contribution #2", type: "poc", statusLabel: "POC in progress", desc: "Three scenarios run simultaneously: product family business rules via RAG (S1), minimum margin threshold optimisation (S2), and competitive intelligence through LLM clustering (S3). A per-reference reliability score accompanies each recommendation to support human decision-making." },
        { num: "04", name: "Integrated Interface", tag: "Output", type: "todo", statusLabel: "To build", desc: "Centralised interface orchestrating all four components in a single end-to-end workflow. Synthesis dashboard with automatic pre-analysis, clustering-based target reference detection, and competitive positioning gap analysis. Human validation enforced before any pricing decision." }
      ]
    },
    skills: {
      title: "Skills",
  ...
  pl: {
    ...
    project: {
      ...
      bricks: [
        ...
        { num: "03", name: "Wieloscenariuszowy Silnik Cenowy", tag: "Wkład #2", type: "poc", statusLabel: "POC w toku", desc: "Trzy scenariusze działają jednocześnie: reguły biznesowe według rodziny produktów przez RAG (S1), optymalizacja minimalnego progu marży (S2) i wywiad konkurencyjny przez klastrowanie LLM (S3). Każda rekomendacja zawiera wskaźnik wiarygodności według referencji." },
        { num: "04", name: "Zintegrowany Interfejs", tag: "Wypadkowa", type: "todo", statusLabel: "Do zbudowania", desc: "Centralny interfejs orkiestrujący cztery elementy w jednym workflow end-to-end. Dashboard syntezy z automatyczną pre-analizą, wykrywaniem referencji do targetowania przez klastrowanie i analizą luk w pozycjonowaniu konkurencyjnym. Obowiązkowa walidacja ludzka przed każdą decyzją cenową." }
      ]
    },
    skills: {
      title: "Kompetencje",
